...
class _ContactPageState extends State<ContactPage> {
  ...
  List<String> _roles = ['provider', 'admin'];
  ...
  Future<List<String>> _getEmails() async {
    List<String> emails = [];
    try {
      // Use 'admin' collection when 'admin' role is selected
      String collectionName = _selectedRole == 'admin' ? 'admin' : _selectedRole.toUpperCase();
